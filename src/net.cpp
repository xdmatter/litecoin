...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Xdmatter " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"xdmattertools.com", "dnsseed.xdmattertools.com"},
    {"xdmatterpool.org", "dnsseed.xdmatterpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"xdmattertools.com", "testnet-seed.xdmattertools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Xdmatter is probably already running."), addrBind.ToString().c_str());
        else
