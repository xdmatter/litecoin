...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/xdmatter-qt.exe
    File /oname=COPYING.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/xdmatterd.exe
    ...
    Delete /REBOOTOK $INSTDIR\xdmatter.exe
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\xdmatter-qt.exe
